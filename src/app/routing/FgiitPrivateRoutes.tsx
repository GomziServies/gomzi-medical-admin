...
import MedicalProductList from '../pages/fgiit/gomzi-nutrition/product-list'
import { AddMedicalProduct } from '../pages/fgiit/gomzi-nutrition/add-product'
import { EditMedicalProduct } from '../pages/fgiit/gomzi-nutrition/edit-product'
